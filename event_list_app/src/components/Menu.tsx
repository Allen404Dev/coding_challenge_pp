...
const Menu = () => {
  ...
  return (
    <header className="bg-[#0f172a] text-white shadow-md fixed top-0 left-0 w-full border-b-[1px] border-blue-400">
      <div className="container mx-auto flex items-center justify-end relative h-20">
        <img src={logoIconX} className="w-32 absolute top-10 left-0" />
